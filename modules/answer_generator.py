...
def create_answer_generator(memory=None):
    llm = ModelLLM(model="gemma3", temperature=0.7)
    
    prompt = PromptTemplate(
        input_variables=["user_question", "query_result"],
        template="""Anda adalah Generator Jawaban NL2SQL yang dirancang untuk memberikan jawaban yang jelas dan ringkas dalam **bahasa Indonesia** berdasarkan hasil query SQL.
        ...
        3. Sajikan jawaban dalam **bahasa Indonesia** dengan tata bahasa yang benar dan gaya bahasa yang ramah pengguna.
        4. Jangan gunakan istilah teknis seperti "SQL", "query", atau "database" dalam jawaban.
        5. Jangan beri sintaks SQL ke pengguna. 
        6. Jika ada permintaan yang bersifat destruktif, seperti ""INSERT", "UPDATE", atau "DELETE", tolak permintaan tersebut dengan sopan.
        7. Jika mengandung informasi pribadi seperti KTP, Email, atau Nomor Telepon, jangan tampilkan informasi pribadi tersebut.
        Contoh 1: 
